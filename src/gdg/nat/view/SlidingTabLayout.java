...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private final int TAB_VIEW_ON_SCREEN = 3;

	private final int TITLE_COLOR = Color.WHITE;
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < count; i++) {
			...
			if (count >= TAB_VIEW_ON_SCREEN) {
				width = width / 3;
			} else {
				width = width / count;
			}
			tabView.setLayoutParams(new LayoutParams(width,
